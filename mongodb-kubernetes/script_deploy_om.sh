...
kubectl get pods
echo "Finish. Type 'kubectl apply -f mongodb-sharded-creation.yaml' to deploy the sharded cluster"
# kubectl apply -f mongodb-sharded-creation.yaml
# mongoshurlsharded="mongodb://backupuser:mongod123XMONGOD123x@a83de7939f4ef41e299441c642dc15bb-88397176.eu-west-1.elb.amazonaws.com:27017/?directConnection=true&authMechanism=SCRAM-SHA-256&authSource=admin"
# lbrssvcurl=`kubectl get svc mongodb-sharded-svc-ext -o json | jq -r '.status.loadBalancer.ingress[0].hostname'`
