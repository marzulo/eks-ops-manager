...
openssl x509 -sha256 -req -days 730 -in RS-test-server1.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-test-server1.crt -extfile openssl-test-rs1.cnf -extensions v3_req
openssl x509 -sha256 -req -days 730 -in RS-test-serverom.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-test-serverom.crt -extfile openssl-test-om.cnf -extensions v3_req
...
openssl x509 -sha256 -req -days 730 -in RS-rsbackup.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-rsbackup.crt -extfile openssl-rsbackup.cnf -extensions v3_req
openssl x509 -sha256 -req -days 730 -in RS-rsbkpagent.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-rsbkpagent.crt -extfile openssl-rsbkpagent.cnf -extensions v3_req
...
openssl x509 -sha256 -req -days 730 -in RS-rssearch.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-rssearch.crt -extfile openssl-rssearch.cnf -extensions v3_req
openssl x509 -sha256 -req -days 730 -in RS-rssearch-agent.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-rssearch-agent.crt -extfile openssl-rssearch-agent.cnf -extensions v3_req
...
openssl x509 -sha256 -req -days 730 -in RS-searcht.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-searcht.crt -extfile openssl-searcht.cnf -extensions v3_req

cat RS-searcht.crt RS-test-server.key > test-searcht.pem

## generating pocbrace certificates
openssl req -new -key RS-test-server.key -out RS-pocbrace.csr -config openssl-pocbrace.cnf -batch
openssl req -new -key RS-test-server.key -out RS-rspbagent.csr -config openssl-rspbagent.cnf -batch
openssl x509 -sha256 -req -days 730 -in RS-pocbrace.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-pocbrace.crt -extfile openssl-pocbrace.cnf -extensions v3_req
openssl x509 -sha256 -req -days 730 -in RS-rspbagent.csr -CA CA-test-ia.crt -CAkey CA-test-ia.key -CAcreateserial -out RS-rspbagent.crt -extfile openssl-rspbagent.cnf -extensions v3_req

cat RS-pocbrace.crt RS-test-server.key > test-pocbrace.pem
cat RS-rspbagent.crt RS-test-server.key > test-rspbagent.pem
